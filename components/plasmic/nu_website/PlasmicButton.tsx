...
import sty from "./PlasmicButton.module.css"; // plasmic-import: jGsW_a0TMYi/css
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__mvmnU)}
                role={"img"}
              />
            ),
      ...
      >
        {p.renderPlasmicSlot({
          ...
          className: classNames(sty.slotTargetChildren, {
            ...
            [sty.slotTargetChildrencolor_clear_active_shape_sharp]:
              hasVariant($state, "shape", "sharp") &&
              hasVariant($state, "color", "clear") &&
              hasVariant($state, "active", "active"),
            [sty.slotTargetChildrencolor_clear_shape_sharp]:
              hasVariant($state, "color", "clear") &&
              hasVariant($state, "shape", "sharp"),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon2Icon
                className={classNames(projectcss.all, sty.svg__dqiDc)}
                role={"img"}
              />
            ),
